        ...
        <div className="relative">
            ...
            >
                <div className="flex flex-col px-12 w-full text-center items-center sm:mt-10 sm:pt-4 lg:pt-10">
                    ...
                    <button
                        className="w-44 mx-8 h-12 border-2 border-white rounded-[25px] font-bold mb-6 sm:text-2xl sm:mb-10 mt-2 sm:mt-10 sm:w-72 ">{t('hero-button')}</button>
                </div>
            </div>
            <div className="w-screen sm:hidden">
                <video autoPlay loop muted playsInline  className="rounded-bl-[85px]" poster={"/thumbnail.webp"}>
