...
const ResponsiveMenu = ({edit, setEdit}: ResponsiveMenu) => {
    // TODO: WHEN CLICK ON LINK SET EDIT FALSE
    return (
        <>
            {edit ? (
                    <div className="relative h-10 w-6 mt-1 -mr-2 lg:hidden">
                        <div
                            className="absolute flex flex-col items-center place-content-evenly z-50 transform translate-y-16 -translate-x-32 p-2 w-auto bg-softGreen rounded-md text-white sm:translate-x-10">
